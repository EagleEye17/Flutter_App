...
class Asuncion extends StatefulWidget {
  @override
  _AsuncionState createState() => _AsuncionState();
}

class _AsuncionState extends State<Asuncion> {
  String timeURL= 'https://worldtimeapi.org/api/timezone/America/Asuncion';
  String currtime;
  String currdate;
  String finaltime;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("America - Asuncion", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
      ),
    ...
    body: 
      ...
      child:
          ...
          ?Column(
            children: [
            SizedBox(height: 150),
            Image(height: 80, image: AssetImage("assets/flags/asuncion.png",)),
            SizedBox(height: 20),
            ...
            SizedBox(height: 20),
            Center(child: 
              Text(currtime, style: TextStyle(fontSize: 29, fontWeight: FontWeight.w600, letterSpacing: 1)),)
            ],
      )
