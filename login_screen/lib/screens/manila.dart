...
class _PHScreenState extends State<PHScreen> {
  String timeURL= 'https://worldtimeapi.org/api/timezone/Asia/Manila';
  String currtime;
  String currdate;
  String finaltime;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Asia - Manila, Philippines", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
      ),
    ...
    body: 
      ...
      child:
          ...
          ?Column(
            children: [
            SizedBox(height: 150),
            Image(height: 80, image: AssetImage("assets/flags/phl.jpg",)),
            SizedBox(height: 20),
            Text("Asia/Manila",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, fontFamily: 'Poppins'),
                ),
            SizedBox(height: 20),
            Center(child:
